...
<section id="wrapper">
    ...
    <div class="login-register">
        ...
        <div class="login-logo text-center py-5">
            <a href="#" style="display: inline-block;background: #fff;padding: 10px;border-radius: 5px;"><img style="width: 250px" src="{{ asset('images/logo_web.png') }}"> </a>
        </div>
