      ...
      if(code == ''){
        ...
        window.scrollTo(0,0);
          ...
          window.scrollTo(0,0);
           ...
           database.collection('parcel_coupons').doc(id).set({'code':code,'description':description,'discount':discount,'expiresAt':expiresAt,'isEnabled':isEnabled,'id':id,'discountType':discountType,'image':photo_coupon}).then(function(result) {
