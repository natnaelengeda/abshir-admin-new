...
<div class="page-wrapper">
	<div class="row page-titles">
		...
		<div class="col-md-7 align-self-center">
          ...
          <li class="breadcrumb-item"><a href= "{!! route('parcel_coupons') !!}" >{{trans('lang.parcel_plural')}}  {{trans('lang.coupon_plural')}}</a></li>
        ...
        <div class="error_top" style="display:none"></div>
         ...
         <a href="{!! route('parcel_coupons') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
  ...
  jQuery("#data-table_processing").show();
      ...
      ref.get().then( async function(snapshots){
        ...
        if (parcel_coupons.image!='' && parcel_coupons.image!=null) {
          photo_coupon = parcel_coupons.image;
...
$(".save_coupon_btn").click(function(){
    ...
    if(code == ''){
      ...
      database.collection('parcel_coupons').doc(id).update({'code':code,'description':description,'discount':discount,'expiresAt':expiresAt,'isEnabled':isEnabled,'id':id,'discountType':discountType,'image':photo_coupon}).then(function(result) {
