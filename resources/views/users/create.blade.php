					...
					<div class="vendor_payout_create-inner">
						...
						<fieldset>
							...
							<div class="form-group row width-50">
								...
								<div class="col-7">
									<input type="text" class="form-control user_latitude" onkeypress="return chkAlphabets3(event,'error5')"><div id="error5" class="err"></div>
									<div class="form-text text-muted w-50">
							...
							<div class="form-group row width-50">
								...
								<div class="col-7">
									<input type="text" class="form-control user_longitude" onkeypress="return chkAlphabets3(event,'error6')"><div id="error6" class="err"></div>
									<div class="form-text text-muted w-50">
