		...
		<div class="col-md-7 align-self-center">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a
						href="{!! route('vehicleType') !!}">{{trans('lang.vehicle_type')}}</a></li>
	...
	$(".create_user_btn").click(function () {
		...
		if (name == '') {
			...
			database.collection('vehicle_type').doc(id).set({
				...
				'sectionId': section, 'short_description': short_description, 'description': description, 'supported_vehicle': supported_vehicle, 'vehicle_icon': photo, 'isActive': active,
