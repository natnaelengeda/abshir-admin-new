...
$(document).ready(function () {
  ...
  $(".save_coupon_btn").click(function () {
    ...
    if (code == '') {
      ...
      database.collection('promos').doc(id).set({ 'code': code, 'description': description, 'discount': discount, 'expiresAt': expiresAt, 'isEnabled': isEnabled, 'id': id, 'discountType': discountType, 'image': photo_promo }).then(function (result) {
