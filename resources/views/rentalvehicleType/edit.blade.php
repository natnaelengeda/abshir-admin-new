...
$(".create_user_btn").click(function(){
	...
	if(name == ''){
		...
		jQuery("#data-table_processing").show();
		database.collection('rental_vehicle_type').doc(id).update({'id':id, 'name':name, 'capacity':capacity,'short_description':short_description,'description':description, 'supported_vehicle':supported_vehicle, 'rental_vehicle_icon':photo, 'isActive':active,
